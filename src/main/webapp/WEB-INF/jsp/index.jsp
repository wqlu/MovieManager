...
<script type="text/javascript" src="../../assets/js/jquery-easyui-1.4.1/jquery.min.js"></script>
    	...
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	...
         	<li>
         	 ...
         	 <li>
         		<span>电影管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'movie-add'}">新增电影</li>
	         		<li data-options="attributes:{'url':'movie-list'}">查询电影</li></ul>
         	</li>
         </ul>
    </div>
